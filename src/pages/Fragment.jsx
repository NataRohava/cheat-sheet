...
export const Fragment = () => {
  return (
    <div>
      ...
      <p>
        С помощью фрагментов можно{" "}
        <span style={{ backgroundColor: "#C0C0C0" }}>
          сгруппировать список дочерних элементов без добавления дополнительных
          узлов в DOM{" "}
        </span>{" "}
        .
      </p>
...
`}
      ...
      <p>
        ...
        Недостаток сокращенной записи:{" "}
        <b style={{ color: "#A52A2A" }}>нельзя использовать атрибуты</b> ,
