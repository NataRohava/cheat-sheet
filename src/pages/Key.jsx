...
export const Key = () => {
  return (
    <div>
      <h2>Key (ключ)</h2>
      <p>
        <b>Ключи</b> помогают React{" "}
        <span style={{ backgroundColor: "#C0C0C0" }}>
          определять, какие элементы были изменены, добавлены или удалены
        </span>{" "}
        .Их необходимо указывать, чтобы React мог сопоставлять элементы массива
        с течением времени.
        <br />
        Ключи используются для определения уникальности каждого элемента массива
        и обеспечения эффективного процесса обновления компонентов при
        необходимости.
      </p>
...
`}
      ...
      <p>
        ...
        отличать элемент списка от его соседей. Чаще всего будем{" "}
        <b style={{ color: "#A52A2A" }}>использовать ID из данных как ключи </b>{" "}
        .
      </p>
      <SyntaxHighlighter language="javascript" style={a11yLight}>
...
`}
      ...
      <p>
        Ключи <b>нужно определять непосредственно внутри массивов </b> . Если не
      ...
      <p>
        Ключи <b>оптимизируют работу с элементами массивов</b>, уменьшают
        количество ненужных удалений и созданий элементов.Без key механизм
